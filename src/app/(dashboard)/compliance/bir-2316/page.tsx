...
export default function ComplianceBir2316Page() {
  const [year, setYear] = useState("2025");

  const nav = <ComplianceNav currentHref="/compliance/bir-2316" />;

  return (
    <DashboardShell
      topbarTitle="Compliance"
      topbarSubtitle="Annual Certificate of Compensation"
      topbarTrailing={
        <>
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        <SettingsLayout nav={nav}>
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            <Text variant="body" as="h2" className="mb-2 font-semibold text-foreground">BIR Form 2316 — {year}</Text>
            <Text variant="caption" as="p" className="text-muted-foreground">
              Certificate of Compensation and Tax Withheld. Generate per employee for the year.
            </Text>
          </div>
        </SettingsLayout>
      </div>
